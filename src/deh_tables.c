...
const char *const STATE_LIST[] = { // array length left dynamic for sanity testing later.
	...
	"S_EMERALDORBIT", //SCS ADD
	"S_XEMBEAM",
	
	"S_MINIHYUDORO", //SCS ADD
	
	"S_YOGOSPRING1", //SCS ADD
	"S_YOGOSPRING2",
	"S_YOGOSPRING2B",
	"S_YOGOSPRING3",
	"S_YOGOSPRING4",
	
	"S_BOGOSPRING1", //SCS ADD
	"S_BOGOSPRING2",
	"S_BOGOSPRING2B",
	"S_BOGOSPRING3",
	"S_BOGOSPRING4",
	
	"S_NORMALSHIELD1", //SCS ADD
	
	"S_MEGACHOPPER1", //SCS ADD
	"S_MEGACHOPPERDEAD",
	
	"S_ARMASHIELD1", //SCS ADD
	"S_ARMASHIELD2",
	
	"S_AFTERBURNERJAWZ_IDLE", //SCS ADD
	"S_AFTERBURNERJAWZ_JUMP",
	"S_AFTERBURNERJAWZ_WHEEL",
	"S_AFTERBURNERJAWZ_A",
	"S_AFTERBURNERJAWZ_B",
	"S_AFTERBURNERRETICLE",
	"S_AFTERBURNERJAWZ_DEAD1",
	"S_AFTERBURNERJAWZ_DEAD2",
	
	"S_PRESSUREMINE",				//SCS ADD
	"S_PRESSUREMINE_EXPLODE",
	...
	"S_RINGGUNSTRONG",		//SCS ADD
	"S_RINGGUNMAX",
	"S_RINGGUNLIGHTS",
	
	"S_BHYUDORO",			//SCS ADD
	"S_BHYUDORO_RETURNING",
	
	"S_INKBUBBLE",			//SCS ADD
	
	"S_TIMESTONEACTIVATE", //SCS ADD
	"S_TIMESTONEIDLE",
	
	"S_KARTINVULN_SMALL1",	//SCS ADD
	"S_KARTINVULN_SMALL2",
	"S_KARTINVULN_SMALL3",
	"S_KARTINVULN_SMALL4",
	"S_KARTINVULN_SMALL5",
...
const char *const MOBJTYPE_LIST[] = {  // array length left dynamic for sanity testing later.
	...
	"MT_BOGOSPRING", //SCS ADD
	
	"MT_NORMALSHIELD",	//SCS ADD
	"MT_NORMALSHIELD_VISUAL",
	
	"MT_MEGACHOPPER",	//SCS ADD
	
	"MT_ARMASHIELD",	//SCS ADD
	"MT_ARMASHIELD_VISUAL1",
	"MT_ARMASHIELD_VISUAL2",
	
	"MT_AFTERBURNER_JAWZ", //SCS ADD
	"MT_ABJZBOOSTER",
	"MT_ABURNERRETICLE",
	
	"MT_PRESSUREMINE",		//SCS ADD
	
	"MT_XSNAPSHOT",			//SCS ADD
	"MT_XSNAPLASTSHOT",
	"MT_XSNAPLASTORBITSHOT",
	"MT_XSNAPMISFIRE",
	"MT_XSNAPLASTSHOTSHRINK",
	
	"MT_RINGGUNBLASTSTRONG",		//SCS ADD
	"MT_RINGGUNBLASTMAX",
	"MT_RINGGUNLIGHTS",
	"MT_RINGGUNLARGESHOT",
	...
	"MT_INKBUBBLE",					//SCS ADD
	
	"MT_TIMESTONEACTIVATE",			//SCS ADD
	"MT_TIMESTONEIDLE",
	
	"MT_SPARKLETRAILOLD",			//SCS ADD
	
	"MT_TIMESTONESPARKLE",			//SCS ADD
	
	"MT_SUPERFORMSPARKLE",			//SCS ADD
	
	"MT_SIGNPOSTRIBBON",			//SCS ADD
};
...
#undef  FOREACH
	...
	{"KRITEM_DECABANA", KRITEM_DECABANANA},				//SCS ADD
	{"KRITEM_DUALABURNERJAWZ", KRITEM_DUALABURNERJAWZ},			//SCS ADD
	...
	//{"KSM_SUPERJACKPOT", KSM_SUPERJACKPOT},
	{"KSM__MAX", KSM__MAX},
	...
	{"KSHIELD_NORMAL",KSHIELD_NORMAL},		//SCS ADD
	{"KSHIELD_ARMA",KSHIELD_ARMA},		//SCS ADD
