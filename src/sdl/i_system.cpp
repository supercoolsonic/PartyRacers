...
#define DEFAULTWADLOCATION1 "/usr/local/share/games/PartyRacers"
#define DEFAULTWADLOCATION2 "/usr/local/games/PartyRacers"
#define DEFAULTWADLOCATION3 "/usr/share/games/PartyRacers"
#define DEFAULTWADLOCATION4 "/usr/games/PartyRacers"
...
FUNCNORETURN void ATTRNORETURN I_Quit(void)
{
	...
	RR_SaveBookmarks();											//SCS - RADIO END
